...
class TransactionValidatorTest {
    ...
    private static final String INVALID_ACCT_NUM = "12345";
    ...
    void validateTransactionFailsWhenAccountNumberInvalid() {
        // Given
        when(transaction.getFromAccountNum()).thenReturn(INVALID_ACCT_NUM);
        ...
        assertEquals(EXCEPTION_MESSAGE_INVALID_NUMBER, exception.getMessage());
    }
}