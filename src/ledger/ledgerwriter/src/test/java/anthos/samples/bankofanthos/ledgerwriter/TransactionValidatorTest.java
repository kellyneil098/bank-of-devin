...
class TransactionValidatorTest {
    ...
    private static final String TO_ACCOUNT_NUM = "1111111111";
    ...
    @Test
    @DisplayName("Given internal transaction with sender account != authenticated account, "
            + "IllegalArgumentException is thrown")
    void validateTransactionFailsWhenSenderNotAuthenticated() {
        // Given
        ...
        assertNotNull(ex);
        assertEquals(EXCEPTION_MESSAGE_NOT_AUTHENTICATED, ex.getMessage());
    }
}