...
class LedgerWriterControllerTest {
    ...
    private static final String EXCEPTION_MESSAGE = "Failed to retrieve balance";
    ...
    @Test
    @DisplayName("Given the transaction is internal and the balance lookup "
            + "throws ResourceAccessException, return HTTP Status 500")
