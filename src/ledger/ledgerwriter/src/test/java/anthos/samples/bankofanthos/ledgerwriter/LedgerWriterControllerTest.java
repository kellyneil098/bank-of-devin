...
class LedgerWriterControllerTest {
    ...
    @Test
    @DisplayName("Given an internal transaction whose amount exceeds the "
            + "sender's available balance, return HTTP Status 400")
    void addTransactionFailsWhenBalanceLessThanAmount(TestInfo testInfo) {
        // Given
        ...
        assertEquals(
                ExceptionMessages.EXCEPTION_MESSAGE_INSUFFICIENT_BALANCE,
